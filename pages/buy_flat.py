...
def buy(root, frame, flat_number, owner_name, phno, email): 
    ...
    elif success == 4: tk.messagebox.showerror("Invalid data", "Phone number already exists")
    elif success == 5: tk.messagebox.showerror("Invalid data", "Email already exists")
    else:
